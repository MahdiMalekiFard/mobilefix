        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div class="col-span-2 grid grid-cols-1 gap-4">
                ...
                <x-card :title="trans('page.media')" shadow separator progress-indicator="submit">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <!-- Image Section -->
                        <div>
                            <x-admin.shared.file-input :label="trans('order.images', locale: app()->getFallbackLocale())"
                                                       wire:model="images"
                                                       multiple
                                                       accept="image/*"
                            />
                        ...
                        <!-- Videos Section -->
                        <div>
                            <x-admin.shared.file-input :label="trans('order.videos', locale: app()->getFallbackLocale())"
                                                       wire:model="videos"
                                                       multiple
                                                       accept="video/*"
                            />
            ...
            <div class="col-span-1">
                <div class="sticky top-20">
                    <x-card :title="trans('general.page_sections.publish_config', locale: app()->getFallbackLocale())" shadow separator progress-indicator="submit">
                        <div class="grid grid-cols-1 gap-4">
