...
<div>
    <x-user.shared.bread-crumbs :breadcrumbs="$breadcrumbs" :breadcrumbs-actions="$breadcrumbsActions"/>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-gray-900 dark:text-white">Bestelldetails</h1>
                    ...
                    <div class="mt-3 sm:mt-0">
                        @if($model->status)
                            @php
                                $statusEnum = OrderStatusEnum::from($model->status);
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 w-0 flex-1">
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Bestellnummer</dt>
                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 w-0 flex-1">
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Gesamtbetrag</dt>
                                ...
                                <dd class="text-lg font-bold @if($hasTotal) text-green-600 dark:text-green-400 @else text-gray-400 italic @endif">
                                    @if ($hasTotal)
                                        {{ number_format((float) $model->total, 0) }} <span class="font-normal">EUR</span>
                                    @else
                                        nicht angegeben
                                    @endif
                                </dd>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 w-0 flex-1">
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Erstellt</dt>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Kundeninformationen</h3>
                </div>
            </div>
            <div class="p-6">
                <dl class="space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Geräteinformationen</h3>
                </div>
            </div>
            <div class="p-6">
                <dl class="space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Adressinformationen</h3>
                    </div>
                </div>
                <div class="p-6">
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Adresstitel</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white font-medium">{{ $model->address->title }}</dd>
                        </div>
                        @if($model->address->address)
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Vollständige Adresse</dt>
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Leistungen & Reparaturen</h3>
                        </div>
                        <span class="text-sm text-gray-500 dark:text-gray-400">({{ $model->problems->count() }} Dienstleistungen)</span>
                    </div>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                                    ...
                                    <div class="text-right">
                                        @if($problem->min_price || $problem->max_price)
                                            <div class="text-sm font-medium text-gray-900 dark:text-white">
                                                @if($problem->min_price && $problem->max_price)
                                                    @if($problem->min_price == $problem->max_price)
                                                        {{ number_format((int)$problem->min_price, 0) }} EUR
                                                    @else
                                                        {{ number_format((int)$problem->min_price, 0) }} - {{ number_format((int)$problem->max_price, 0) }} EUR
                                                    @endif
                                                @elseif($problem->min_price)
                                                    From {{ number_format((int)$problem->min_price, 0) }} EUR
                                                @elseif($problem->max_price)
                                                    Up to {{ number_format((int)$problem->max_price, 0) }} EUR
                                                @endif
                                            </div>
                                        @else
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Preis auf Anfrage</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Gesamtleistungen:</span>
                            <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $model->problems->count() }} Artikel</span>
                        </div>
                        @php
                        ...
                        @if($totalMinPrice > 0 || $totalMaxPrice > 0)
                            <div class="flex items-center justify-between mt-2">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Geschätzte Preisspanne:</span>
                                <span class="text-sm font-semibold text-green-600 dark:text-green-400">
                            @if($totalMinPrice > 0 && $totalMaxPrice > 0)
                                        {{ number_format((int)$totalMinPrice, 0) }} - {{ number_format((int)$totalMaxPrice, 0) }} EUR
                                    @elseif($totalMinPrice > 0)
                                        Aus {{ number_format((int)$totalMinPrice, 0) }} EUR
                                    @elseif($totalMaxPrice > 0)
                                        Bis zu {{ number_format((int)$totalMaxPrice, 0) }} EUR
                                    @endif
                        </span>
                            </div>
                        @endif
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Kundenhinweis</h3>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Administratorhinweis</h3>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-3 text-lg font-medium text-gray-900 dark:text-white">Anlagen</h3>
                        <span class="ml-2 text-sm text-gray-500 dark:text-gray-400">({{ $model->media->count() }} Dateien)</span>
                    </div>
                </div>
                                        ...
                                        <div class="w-full h-32 bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div class="fallback-image w-full h-32 bg-gray-100 dark:bg-gray-600 items-center justify-center hidden">
                                                <div class="text-center">
                                                    ...
                                                    <span class="text-xs text-gray-500 dark:text-gray-400">Bildvorschau</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                        <div class="w-full h-32 bg-gray-100 dark:bg-gray-600 flex items-center justify-center">
                                            <div class="text-center">
                                                ...
                                                <span class="text-xs text-gray-500 dark:text-gray-400 font-medium">Dokumentieren</span>
                                            </div>
                                        </div>
                                        <!-- File type badge -->
                                        <div class="absolute top-2 right-2">
                                            <span class="bg-gray-500 text-white text-xs px-2 py-1 rounded-full font-medium">DATEI</span>
                                        </div>
                                    @endif
                                </div>
                                        ...
                                        @if(str_starts_with($mime, 'image/'))
                                            <div class="ml-3">
                                                <a href="{{ $media->getUrl() }}" target="_blank"
                                                   class="inline-flex items-center px-2 py-1 border border-gray-300 dark:border-gray-500 rounded-md text-xs font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
