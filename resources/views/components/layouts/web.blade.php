...
<head>
    ...
    @vite(['resources/css/web.css','resources/js/web/web.js'])
...
{{--                        <div class="xl:w-10/12 lg:w-10/12 md:w-10/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!ms-[8.33333333%] lg:!ms-[8.33333333%] md:!ms-[8.33333333%]">--}}
{{--                            <figure class="!mb-6"><img src="/assets/img/illustrations/i7.png" srcset="/assets/img/illustrations/i7@2x.png 2x" alt="image"></figure>--}}
{{--                        </div>--}}
{{--                        <!-- /column -->--}}
{{--                    </div>--}}
{{--                    <!-- /.row -->--}}
...
{{--                                            <div class="!text-start input-group !relative form-floating">--}}
...
{{--                                                <input type="submit" value="Join" name="subscribe" id="mc-embedded-subscribe" class="btn btn-orange !text-white !bg-[#f78b77] border-[#f78b77] hover:text-white hover:bg-[#f78b77] hover:!border-[#f78b77] hover:!translate-none active:text-white active:bg-[#f78b77] active:border-[#f78b77] disabled:text-white disabled:bg-[#f78b77] disabled:border-[#f78b77]">--}}
{{--                                            </div>--}}
...
<div class="progress-wrap fixed w-[2.3rem] h-[2.3rem] cursor-pointer block shadow-[inset_0_0_0_0.1rem_rgba(128,130,134,0.25)] z-[1010] opacity-0 invisible translate-y-3 transition-all duration-[0.2s] ease-[linear,margin-right] delay-[0s] rounded-[100%] right-6 bottom-6 motion-reduce:transition-none after:absolute after:content-['\e951'] after:text-center after:leading-[2.3rem] after:text-[1.2rem] after:!text-[#f78b77] after:h-[2.3rem] after:w-[2.3rem] after:cursor-pointer after:block after:z-[1] after:transition-all after:duration-[0.2s] after:ease-linear after:left-0 after:top-0 motion-reduce:after:transition-none after:font-Unicons">
    <svg class="progress-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102">
        <path class="fill-none stroke-[#f78b77] stroke-[4] box-border transition-all duration-[0.2s] ease-linear motion-reduce:transition-none" d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" />
    </svg>
</div>
