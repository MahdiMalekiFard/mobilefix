    ...
    public function compose(View $view): void
    {
        ...
        $orderMgmt = [
            ...
            'sub_menu' => [
                ...
                [
                    'icon'       => 's-plus-circle',
                    'route_name' => 'admin.order.create',
                    'exact'      => true,
                    'params'     => [],
                    'title'      => trans('_menu.order.create'),
                    'access'     => $user->hasAnyPermission(PermissionsService::generatePermissionsByModel(Order::class, 'Store')),
                ],
            ],
        ];
