...
final class BrandTable extends PowerGridComponent
{
    ...
    public string $tableName     = 'index_brand_datatable';
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('brand.model')])],
        ];
    }
    ...
    {
        return [
            ['link' => route('admin.brand.create'), 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('brand.model')])],
        ];
    }
