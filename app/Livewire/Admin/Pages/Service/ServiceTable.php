...
final class ServiceTable extends PowerGridComponent
{
    ...
    public string $tableName = 'index_service_datatable';
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('service.model')])],
        ];
    }
    ...
    {
        return [
            ['link' => route('admin.service.create'), 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('service.model')])],
        ];
    }
